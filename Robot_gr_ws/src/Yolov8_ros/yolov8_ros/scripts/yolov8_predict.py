...
def predict(cfg=DEFAULT_CFG, use_python=False):
    ...
    model = '/home/hengchih/hengchih/Robot/Robot_ws/src/Yolov8_ros/yolov8_ros/weights/yolov8n-seg.pt'
    source = color_frame
    ...
    if use_python:
        #from ultralytics import YOLO
        # YOLO(model)(**args)
        predicter = YOLO(model=model, task='segment')
    ...
    while not rospy.is_shutdown():
        if color_frame is not None:
            ...
            if results is not None:
                ...
                # segs_msg.header.seq=0
                # segs_msg.header.stamp.secs=0
                # segs_msg.header.stamp.nsecs=0
                # segs_msg.header.frame_id=" "
